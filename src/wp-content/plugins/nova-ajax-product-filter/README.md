...
1. Plugin frontend
2. Nova Ajax Product Filter by Attribute widget settings
3. Nova Ajax Product Filter by Price display type list widget settings
4. Backend settings
...
* Fixed bug - 'novaapf_get_term_objects' funtion was working incorrectly
