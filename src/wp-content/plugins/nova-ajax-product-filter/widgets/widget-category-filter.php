<?php
/**
 * Nova Ajax Product Filter by Category
 */
if (!class_exists('NOVAAPF_Category_Filter_Widget')) {
	class NOVAAPF_Category_Filter_Widget extends WP_Widget {
		/**
		 * Register widget with WordPress.
		 */
		function __construct() {
			parent::__construct(
				'novaapf-category-filter', // Base ID
				__('Nova Ajax Product Filter by Category', 'novaapf'), // Name
				array('description' => __('Filter woocommerce products by category.', 'novaapf')) // Args
			);
		}
		...
		public function form($instance) {
			...
			<p>
				...
				<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo (!empty($instance['title']) ? esc_attr($instance['title']) : __( 'Product Categories', 'novaapf' )); ?>">
			</p>
			<p>
...
// register widget
if (!function_exists('novaapf_register_category_filter_widget')) {
	function novaapf_register_category_filter_widget() {
		register_widget('NOVAAPF_Category_Filter_Widget');
	}
	add_action('widgets_init', 'novaapf_register_category_filter_widget');
}