...
function nova_robeto_get_demo_array($dir_url, $dir_path){

    $demo_items = array(
        'home-01' => array(
            'link'          => 'https://robeto.novaworks.net/',
            'title'         => 'Main Fashion 01',
            ...
            'data_elementor'=> [
                'header'       => [
                    'location' => 'header',
                    'value' => [
                        'header-home-01' => 'include/general',
                    ],
                ],
                'footer'       => [
                    'location' => 'footer',
        ...
        'home-02' => array(
            'link'          => 'https://robeto.novaworks.net/home-v2',
            'title'         => 'Main Fashion 02',
            'data_sample'   => 'data.json',
            'data_product'  => 'products.csv',
            'data_widget'   => 'widget.json',
            ...
            'data_elementor'=> [
                'header'       => [
                    'location' => 'header',
                    'value' => [
                        'header-template-2' => 'include/general',
                    ],
                ],
                'footer'       => [
                    'location' => 'footer',
        ...
        'home-03' => array(
            'link'          => 'https://robeto.novaworks.net/home-v3',
            'title'         => 'Main Fashion 03',
            'data_sample'   => 'data.json',
            'data_product'  => 'products.csv',
            'data_widget'   => 'widget.json',
            'data_slider'   => 'home-06.zip',
            'data_elementor'=> [
                'header'       => [
                    'location' => 'header',
                    'value' => [
                        'header-template-4' => 'include/general',
                    ],
                ],
                'footer'       => [
                    'location' => 'footer',
        ...
        'home-04' => array(
            'link'          => 'https://robeto.novaworks.net/home-v4',
            'title'         => 'Main Fashion 04',
            'data_sample'   => 'data.json',
            'data_product'  => 'products.csv',
            'data_widget'   => 'widget.json',
        ...
        'home-05' => array(
            'link'          => 'https://robeto.novaworks.net/home-v5',
            'title'         => 'Main Fashion 05',
            'data_sample'   => 'data.json',
            'data_product'  => 'products.csv',
            'data_widget'   => 'widget.json',
            'data_elementor'=> [
                'header'       => [
                    'location' => 'header',
                    'value' => [
                        'header-template-2-2' => 'include/general',
                    ],
                ],
                'footer'       => [
                    'location' => 'footer',
        ...
        'home-06' => array(
            'link'          => 'https://robeto.novaworks.net/home-v6',
            'title'         => 'Main Fashion 06',
            'data_sample'   => 'data.json',
            'data_product'  => 'products.csv',
            'data_widget'   => 'widget.json',
            ...
            'data_elementor'=> [
                'header'       => [
                    'location' => 'header',
                    'value' => [
                        'header-template-3' => 'include/general',
                    ],
                ],
                'footer'       => [
                    'location' => 'footer',
        ...
        'home-07' => array(
            'link'          => 'https://robeto.novaworks.net/home-v7',
            'title'         => 'Main Fashion 07',
            'data_sample'   => 'data.json',
            'data_product'  => 'products.csv',
            'data_widget'   => 'widget.json',
            'data_slider'   => 'home-05.zip',
            'data_elementor'=> [
                'header'       => [
                    'location' => 'header',
                    'value' => [
        ...
        'home-08' => array(
            'link'          => 'https://robeto.novaworks.net/home-v8',
            'title'         => 'Main Watches 01',
            'data_sample'   => 'data.json',
            'data_product'  => 'watches.csv',
            'data_widget'   => 'widget.json',
            'data_slider'   => 'home-08.zip',
            'data_elementor'=> [
                'header'       => [
                    'location' => 'header',
                    'value' => [
        ...
        'home-09' => array(
            'link'          => 'https://robeto.novaworks.net/home-v9',
            'title'         => 'Main Furniture 01',
            'data_sample'   => 'data.json',
            'data_product'  => 'furniture.csv',
            'data_widget'   => 'widget.json',
            'data_slider'   => 'home-09.zip',
            'data_elementor'=> [
                'header'       => [
                    'location' => 'header',
                    'value' => [
                        'header-template-3-2' => 'include/general',
                    ],
                ],
                'footer'       => [
                    'location' => 'footer',
        ...
        'home-10' => array(
            'link'          => 'https://robeto.novaworks.net/home-v10',
            'title'         => 'Main Furniture 02',
            'data_sample'   => 'data.json',
            'data_product'  => 'furniture.csv',
            'data_widget'   => 'widget.json',
            'data_slider'   => 'home-10.zip',
            'data_elementor'=> [
                'header'       => [
                    'location' => 'header',
                    'value' => [
