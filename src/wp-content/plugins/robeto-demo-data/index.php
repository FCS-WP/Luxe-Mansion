<?php
/*
Plugin Name:    Robeto Package Demo Data
...
class Robeto_Data_Demo_Plugin_Class{
    ...
    public static $theme_name = 'robeto';

    public static $demo_site = 'https://robeto.novaworks.net/';
...
add_action('plugins_loaded', function(){
    ...
    if(strtolower($theme->get_template()) != 'robeto'){

        add_action( 'admin_notices', function(){
            printf( __( '%1$s"Robeto Package Demo Data" requires %3$s"robeto"%4$s theme to be installed and activated. Please active %3$s"robeto"%4$s to continue.%2$s', 'novaworks-demodata' ), '<div class="error"><p>', '</p></div>' ,'<strong>', '</strong>' );
        });
    ...
    Robeto_Data_Demo_Plugin_Class::get_instance();
}, 999);
